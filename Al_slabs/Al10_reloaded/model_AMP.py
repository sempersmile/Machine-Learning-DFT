...
def generate_data(count, filename='data.traj'):
    ...
    if not os.path.exists(filename):
        ...
        if filename == 'gold.traj' or filename == 'gold2.traj':
            ...
            T = 300
            dt_step = 2
        elif filename == 'Al7.traj':
            atoms = fcc100('Al', (4,6,7), vacuum=20.)
            T = 300
            dt_step = 2
            ...
            T = 300
            dt_step = 2
        elif filename == 'Al10.traj':
            atoms = fcc100('Al', (4,6,10), vacuum=20.)
            T = 300
            dt_step = 2
        elif filename == 'Al12.traj':
...
if __name__ == '__main__':
    ...
    convergence = {'energy_rmse': 0.0017,
                   'energy_maxresid': 0.0028,
                   'force_rmse': 0.1,
                   'force_maxresid': 0.7}
